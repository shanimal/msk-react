        ...
        <div className="middle">
          ...
          <div className="blackBox">
            <div className="contact">
              ...
              <div className="map">
                <a target="_blank" href="http://goo.gl/maps/ohvjr">
                  <img title="Click to view larger map" className="gmap" src="http://maps.google.com/maps/api/staticmap?center=36.84753615757422,-121.39131474501482&amp;zoom=16&amp;markers=icon:http%3A%2F%2Fmsk.shanimal.com%2F_img%2Flogo_map.png%3F4|36.84753615757422,-121.39131474501482&amp;size=500x500&amp;sensor=false"/><br/>
                    View larger map
                </a><br/>
                <a target="_blank" href="http://goo.gl/maps/ohvjr">Get Directions</a>
              </div>
            </div>
          </div></div>
      </div>
